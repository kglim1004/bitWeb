...
servlet(형) + jsp(동생)
>> java 웹 기반으로 기술(x)  >> 계산기 , 그림판 , 원도우 프로그램 >> 웹 (servlet : 자바로 만든 웹용 파일)
...
>> 컴파일 코드 확인
>> D:\bit202107\Web\WebClientLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\WebJSP\org\apache\jsp
