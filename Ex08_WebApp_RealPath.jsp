...
​-----------------------------------------------------------------
URL : http://192.168.0.57:8090/WebJSP/Ex11_WebApp_RealPath.jsp
...
<!-- 
		...
		실경로(소스) : D:\bit202107\Web\WebClientLab\WebJSP\src\main\webapp\Ex09_WebApp_RealPath.jsp
		실제 소스 : [배포] 되어서 서비스 되고 있는 소스 >> 톰켓가지는 특정 경로
		
		
		개발 소스 경로 : D:\bit202107\Web\WebClientLab\WebJSP\src\main\webapp\Ex08_WebApp_RealPath.jsp
		톰켓 이클립스 내장 >> 이클립스가 톰켓 배포 경로 >>
		...
		***[동기화] 있어서 [하나 처럼] 움직입니다 ^^
		...
		아파치 톰켓의 서비스 경로 (배포)
		D:\bit202107\Web\WebClientLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP

		
		
		resourcepath >>/download/note.txt
		소스경로 :  D:\bit202107\Web\WebClientLab\WebJSP\src\main\webapp\download\note.txt
		
		배포경로 : D:\bit202107\Web\WebClientLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
 ...
 <%
 	...
 	//ContextPath통한 real path : D:\bit202107\Web\WebClientLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\WebJSP
 	
 	String filePath = application.getRealPath(resourcepath);
 	out.print("real path : " + filePath + "<br>");
 	//D:\bit202107\Web\WebClientLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
