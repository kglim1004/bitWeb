...
public class ConnectionHelper {
	 public static Connection getConnetion(String dsn) { // oracle , mysql ...
	 ...
	 public static Connection getConnetion(String dsn , String id , String pwd) { // oracle , mysql ...
		 Connection conn = null;
		 try {
			 if(dsn.equals("oracle")) {
				    Class.forName("oracle.jdbc.OracleDriver");
			  		conn = DriverManager.getConnection("jdbc:oracle:thin:@192.168.0.57:1521:xe",id,pwd);
			 }else if(dsn.equals("mysql")) {
				    Class.forName("com.mysql.cj.jdbc.Driver");
